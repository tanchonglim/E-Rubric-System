...
{
    public partial class StudentCourseworkListPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (courseworkIterator.hasNext())
            {
                ...
                btn.Text = "Submission";
                btn.Click += gotoStudentSubmissionPage;
        ...
        protected void gotoStudentSubmissionPage(object sender, EventArgs e)
        {
            Button btn = (Button)sender;
            var courseworkID = btn.CommandName;

            Response.Redirect("/UI/StudentSubmissionPage.aspx?courseworkID=" + courseworkID);
        }
